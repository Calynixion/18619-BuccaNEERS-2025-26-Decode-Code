...
public class FieldCentricDrive extends CommandBase {
    ...
    public FieldCentricDrive(Drive drivetrain, DoubleSupplier strafe, DoubleSupplier forward, DoubleSupplier turn) {
    ...
    @Override
    public void execute(){
        drivetrain.fieldCentricDrive(-strafe.getAsDouble(), -forward.getAsDouble(), -turn.getAsDouble());
    }
}
